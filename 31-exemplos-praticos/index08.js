...
const dados = csv.csvToJSONInputOutput('./dados-petrobras-pn.csv');
...
for(let i=0; i<resultados.length; i++) {
	resultados[i] = [parseFloat(resultados[i]).toFixed(2)];
}

csv.insertOutput('./dados-petrobras-pn.csv', resultados);
